# React document editor for Word files
This repository demonstrates example about React Document Editor and how it works for Word files using Syncfusion DOCX Editor. It showcases rich Word document (DOCX) editing and rendering directly within the browser, entirely free from Microsoft Word or Office interop dependencies.
